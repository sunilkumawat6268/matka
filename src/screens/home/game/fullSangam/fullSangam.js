...
export default class FullSangamScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            realDate: "",
                ...
                <ImageBackground style={styles.mainBackImg} source={require('../../../../assets/images/screen_bg.png')} >
                    ...
                    <View style={styles.headerView} >
                        ...
                        <View style={styles.secondHeaderView} >
                            <View>
                                <Text style={styles.homeText} > Full Sangam </Text>
                            </View>
                            <View>
              ...
              return null;
                            ...
                            <View style={styles.inputView}>
                                ...
                                <View style={styles.autoView} >
                                    <Text style={styles.digitText} >Open Panna</Text>
                                    <AutoComplete
                                ...
                                <View style={styles.autoView} >
                                    <Text style={styles.digitText} >Close Panna  </Text>
                        ...
                        renderItem={({ item, index }) =>
                            <View style={styles.mainFlatListView}>
                                <View style={styles.flatListView} >
                                    ...
                                    <View>
                                        <Text style={styles.digitValue} >Open Panna </Text>
                                        <Text style={styles.digitNumber}> {item.digits}</Text>
                                    </View>

                                    <View>
                                        <Text style={styles.digitValue} >Close Panna</Text>
