...
import { Text, View, Button, Platform, SafeAreaView, TouchableOpacity, Image, FlatList, ToastAndroid, ImageBackground } from 'react-native';
import DateTimePicker from '@react-native-community/datetimepicker';
import styles from './styles';
import LottieView from 'lottie-react-native';


export default class PlayBidHistoryScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            date: new Date(),
    ...
    todayBidHistoryData = () => {
        fetch('http://13.127.179.165/api-starline-bid-history-data', {
            method: 'POST',
            headers: {
                                ...
                                <View style={styles.flatListView} >
                                    <View style={styles.subFlatlistView} >
                                        ...
                                        <View>
                                            ...
                                            <Text style={styles.gameNameSecond} >{(item.pana === "Half Sangam") ? item.session === "Close" ? "Digit :" : "Digit : " : item.pana === "Jodi Digit" ? "Digit : " : item.pana === "Full Sangam" ? "Pana :" : item.pana === "Single Pana" ? item.session === "Close" ? "Pana :" : "Pana :" : item.pana === "Single Digit" ? item.session === "Close" ? "Digit : " : "Digit :" : item.pana === "Triple Pana" ? item.session === "Close" ? "Pana :" : "Pana :" : item.pana === "Double Pana" ? item.session === "Close" ? "Pana :" : "Pana :" : " Pana : "} <Text style={styles.gamePoint} >{item.digits}</Text></Text>
