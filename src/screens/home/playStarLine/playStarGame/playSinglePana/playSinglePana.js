...
export default class PlaySinglePanaScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            digits: "",
                ...
                <ImageBackground style={styles.mainBackImg} source={require('../../../../../assets/images/screen_bg.png')} >
                    <View style={styles.headerView} >
                        ...
                        <View style={styles.secondHeaderView} >
                            <View>
                                <Text style={styles.homeText} > Single Pana </Text>
                            </View>
                            <View>
                            ...
                            <View>
                                <TouchableOpacity style={styles.timeView} >
                                    <FlatList
                                        ...
                                        renderItem={({ item }) =>
                                            <View style={styles.flatListView1} >
                                                <Text style={styles.withDrawtimeText}  > Date :  {item.new_date}</Text>
                                            </View>
                                        }
                                    />
                                    <Text style={styles.withDrawtimeText}  >Wallet :  {walletUpdateBal}</Text>
